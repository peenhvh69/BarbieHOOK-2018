...
void Hooks::OnRenderStart() {
	...
	if (g_menu.main.misc.viewmodel_override.get())
	{
		g_csgo.m_view_render->m_view.m_viewmodel_fov = g_menu.main.misc.viewmodel_fov.get();

		if (g_csgo.viewmodel_offset_x->GetFloat() != g_menu.main.misc.viewmodel_offset_x.get())
		{
			*(float*)((DWORD)&g_csgo.viewmodel_offset_x->m_callbacks + 0xC) = 0.0f;
			g_csgo.viewmodel_offset_x->SetValue(g_menu.main.misc.viewmodel_offset_x.get());
		}

		if (g_csgo.viewmodel_offset_y->GetFloat() != g_menu.main.misc.viewmodel_offset_y.get())
		{
			*(float*)((DWORD)&g_csgo.viewmodel_offset_y->m_callbacks + 0xC) = 0.0f;
			g_csgo.viewmodel_offset_y->SetValue(g_menu.main.misc.viewmodel_offset_y.get());
		}

		if (g_csgo.viewmodel_offset_z->GetFloat() != g_menu.main.misc.viewmodel_offset_z.get())
		{
			*(float*)((DWORD)&g_csgo.viewmodel_offset_z->m_callbacks + 0xC) = 0.0f;
			g_csgo.viewmodel_offset_z->SetValue(g_menu.main.misc.viewmodel_offset_z.get());
		}
	}
}
