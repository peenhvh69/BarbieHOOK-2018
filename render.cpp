...
void render::init() {
	...
	esp = Font(XOR("Tahoma"), 12, FW_NORMAL, FONTFLAG_DROPSHADOW); //skeet like idk
	esp_small = Font(XOR("Small Fonts"), 8, FW_NORMAL, FONTFLAG_OUTLINE);
	hud = Font(XOR("Tahoma"), 12, FW_NORMAL, FONTFLAG_DROPSHADOW);
	indicators = Font(XOR("Smallest Pixel-7"), 11, FW_NORMAL, FONTFLAG_ANTIALIAS);
...
void render::gradient_line(int x, int y, int w, int h, Color c1, Color c2)
{
