...
public:
	...
	void AntiFreestand(Player* pEnemy, LagRecord* record, float& y, float flLeftDamage, float flRightDamage, float flRightFraction, float flLeftFraction, float flToMe, int& iShotsMissed);
